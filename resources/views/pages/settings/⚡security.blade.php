...
<section class="w-full">
    ...
    <x-pages::settings.layout :heading="__('Perbarui sandi')" :subheading="__('Pastikan akun Anda menggunakan kata sandi yang panjang dan acak agar tetap aman')">
        ...
        @if ($canManageTwoFactor)
            <section class="mt-12">
                <flux:heading>{{ __('Autentikasi Dua Faktor (2FA)') }}</flux:heading>
                    ...
                    @else
                        <div class="space-y-4">
                            <flux:text variant="subtle">
                                {{ __('Saat Anda mengaktifkan 2FA, Anda akan diminta memasukkan PIN aman saat login. PIN ini dapat diambil dari aplikasi TOTP di ponsel Anda.') }}
                            </flux:text>
